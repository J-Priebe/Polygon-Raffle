    ...
    <div className="raffle-creator">
        <div className="side left">
            ...
            <div className="input-group">
                ...
                <InputNumber onChange={e=> { setNumTickets(e.toString());}}
                    value={numTickets}
                    type="number"
            ...
            <div className="input-group">
                ...
                <InputNumber onChange={e=> { setTicketPrice(e.toString()); }}
                    value={ticketPrice}
            ...
            <div className="input-group">
                ...
                value={benefactorAddress} onChange={addr=>
                    {setBenefactorAddress(addr);}}
                    placeholder="Leave blank if winnings return to creator."
                    />
            </div>
            ...
            <div className="input-group">
                ...
                <Input disabled={true} value={contracts?.RaffleFactory?.address}
            ...
            <div className="subtext">Raffle will only be started when NFT is transferred to the raffle wallet.<br/> <a
                    href="#" target="_blank">Click here to find out how.</a></div>
        </div>
        <div className="side right">
            ...
            <div className="ticket-preview">
                ...
                {ticketPreview ?
                <Image src={ticketPreview} className="nft-preview" /> : ""}
                {/* TODO refresh upon transaction complete instead of waiting for poll.. */}
            </div>
        </div>
    </div>
